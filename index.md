...
<![if !supportTabStrip]>
<link id="shLink" href="index_file/sheet001.htm">
 ...
 <x:ExcelWorkbook>
  <x:ExcelWorksheets>
   <x:ExcelWorksheet>
    ...
    <x:WorksheetSource HRef="index_file/sheet001.htm"/>
   </x:ExcelWorksheet>
  </x:ExcelWorksheets>
...
<frameset rows="*,39" border=0 width=0 frameborder=no framespacing=0>
 <frame src="index_file/sheet001.htm" name="frSheet">
 <frame src="index_file/tabstrip.htm" name="frTabs" marginwidth=0 marginheight=0>
 <noframes>
  <body>
